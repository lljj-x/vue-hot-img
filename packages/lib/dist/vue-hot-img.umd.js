...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['vue-hot-img'] = {}));
  ...
  _.dealEdgeValue = function (itemInfo, styleInfo, container) {
  ...
  var changeSize = {
    bind: function bind(el, binding, vnode) {
      ...
      function handleMouseDown(e) {
        ...
        var container = _.getOffset(zone.parentNode);
        ...
        var preX = _.getPageX(e);

        var preY = _.getPageY(e);

        var flag; // Hide the info displayed by hover

        vnode.context.handlehideZone(true);
        window.addEventListener('mousemove', handleChange);
        window.addEventListener('mouseup', handleMouseUp); // eslint-disable-next-line no-shadow

        function handleChange(e) {
          e.preventDefault();
          flag = true;
          var moveX = _.getPageX(e) - preX;
          var moveY = _.getPageY(e) - preY;
          preX = _.getPageX(e);
          preY = _.getPageY(e); // Handling the situation when different dragging points are selected

          var styleInfo = _[pointer](itemInfo, moveX, moveY); // Boundary value processing
  ...
  var dragItem = {
    bind: function bind(el, binding, vnode) {
      ...
      function handleMouseDown(e) {
        ...
        var container = _.getOffset(el.parentNode);
        ...
        function handleChange(e) {
          ...
          leftPer = _.decimalPoint(moveX / container.width + setting.leftPer); // Hotzone moving boundary processing
  ...
  var __vue_render__ = function __vue_render__() {
    ...
    return _c("div", {
      ...
      directives: [{
        name: "change-size",
        rawName: "v-change-size"
      }],
      staticClass: "hz-m-box",
      class: {
        "hz-z-hidden": _vm.tooSmall,
        "hz-m-hoverbox": !_vm.hideZone
      }
    }, [_c("li", {
      staticClass: "hz-u-index",
      attrs: {
        title: "热区" + (_vm.index + 1)
      }
    }, [_vm._v("\n            " + _vm._s(_vm.index + 1) + "\n        ")]), _vm._v(" "), _c("li", {
      directives: [{
        name: "show",
      ...
      on: {
        click: function click($event) {
          ...
          return _vm.delItem(_vm.index);
        }
      }
    }, [_c("svg", {
      staticClass: "hz-u-close-icon",
      attrs: {
      ...
      staticClass: "hz-u-square hz-u-square-tl",
      attrs: {
        "data-pointer": "dealTL"
      }
    }), _vm._v(" "), _c("li", {
      staticClass: "hz-u-square hz-u-square-tc",
      attrs: {
        "data-pointer": "dealTC"
      }
    }), _vm._v(" "), _c("li", {
      staticClass: "hz-u-square hz-u-square-tr",
      attrs: {
        "data-pointer": "dealTR"
      }
    }), _vm._v(" "), _c("li", {
      staticClass: "hz-u-square hz-u-square-cl",
      attrs: {
        "data-pointer": "dealCL"
      }
    }), _vm._v(" "), _c("li", {
      staticClass: "hz-u-square hz-u-square-cr",
      attrs: {
        "data-pointer": "dealCR"
      }
    }), _vm._v(" "), _c("li", {
      staticClass: "hz-u-square hz-u-square-bl",
      attrs: {
        "data-pointer": "dealBL"
      }
    }), _vm._v(" "), _c("li", {
      staticClass: "hz-u-square hz-u-square-bc",
      attrs: {
        "data-pointer": "dealBC"
      }
    }), _vm._v(" "), _c("li", {
      staticClass: "hz-u-square hz-u-square-br",
      attrs: {
        "data-pointer": "dealBR"
      }
    })])]);
  ...
  var addItem = {
    bind: function bind(el, binding, vnode) {
      ...
      function handleMouseDown(e) {
        ...
        var container = _.getOffset(el); // Only used once at the beginning of init
        ...
        function handleChange(e) {
          ...
          var moveY = _.getPageY(e) - preY;
          preX = _.getPageX(e);
          preY = _.getPageY(e); // Not consider the direction of movement first, consider only the lower right drag point

          var minLimit = 0;

          var styleInfo = _.dealBR(itemInfo, moveX, moveY, minLimit); // Boundary value processing
  ...
  var script$1 = {
    ...
    methods: {
      findCurSelect: function findCurSelect() {
        return this.value.find(function (item) {
          return item.selected;
        });
      },
      onSelect: function onSelect(zone) {
        var curZone = this.findCurSelect();
      ...
      addItem: function addItem(setting) {
        this.zones = [].concat(_toConsumableArray(this.zones), [_objectSpread2(_objectSpread2({}, setting), {}, {
          extra: {}
        })]);
        this.hasChange();
      ...
      removeItem: function removeItem() {
        var index = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.zones.length - 1;
        var curZone = this.zones[index]; // 移除当前选中的
      ...
      changeItem: function changeItem(info) {
        var index = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.zones.length - 1;
    ...
    return _c("div", {
      ...
      return _c("zone", {
        ...
        on: {
          ...
          changeInfo: function changeInfo($event) {
            return _vm.changeInfo($event);
          }
        },
        nativeOn: {
          click: function click($event) {
            return _vm.onSelect(zone);
          }
        }
      });
    }), 1)]);
