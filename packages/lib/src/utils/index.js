 ...
 * @return {Number}
 */
_.decimalPoint = (val = 0) => Math.round(val * _.getMultiple()) / _.getMultiple() || 0;
 ...
 * @return {Number}
 */
_.getDistanceX = (e, container) => _.getPageX(e) - (container.getBoundingClientRect().left + window.pageXOffset);
 ...
 * @return {Number}
 */
_.getDistanceY = (e, container) => _.getPageY(e) - (container.getBoundingClientRect().top + window.pageYOffset);
